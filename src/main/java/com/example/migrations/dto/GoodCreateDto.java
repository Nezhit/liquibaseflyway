...
@Getter
@Schema(description = "Data Transfer Object for creating a new good, detailing its type, title, and associated producer. This DTO focuses on cataloging goods in a store or inventory system.")
